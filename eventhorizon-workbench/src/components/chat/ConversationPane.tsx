...
import type { AgentPhase, AgentRun, AgentSessionDetail, FileChange } from "@/types";
      ...
      <div className="flex shrink-0 items-center justify-between gap-3 border-b border-border/70 px-4 py-3 sm:px-5">
        ...
        <div className="flex min-w-0 items-center gap-2">
          ...
          <select
            ...
            disabled={!currentSession || currentSession.id.startsWith("draft_") || isUpdatingConversation || availableModels.length === 0}
