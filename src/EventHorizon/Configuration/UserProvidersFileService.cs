...
public sealed class UserProvidersFileService : IUserProvidersFileService
{
    ...
    public void Save(AppOptions options)
    {
        ...
        {
            [nameof(AppOptions.CurrentDefaultProvider)] = options.CurrentDefaultProvider,
            [nameof(AppOptions.Providers)] = JsonSerializer.SerializeToNode(
    ...
    private static string CreateInitialContent()
        => new JsonObject
        {
            [nameof(AppOptions.Providers)] = new JsonObject(),
